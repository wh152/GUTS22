...
class IPNetMask {
  ...
  /*
   Regular Experssions in Java 11
  ...
  */
  ...
  protected static String binary(int v) {
    ...
    for (int shift = 0; shift < 32; ++shift) {
      int mask = 0x00000001 << shift;
      b = String.format("%s%s", (mask & v) == mask ? "1" : "0", b);
    }

    // make easily readable, using nibbles with spaces in between
    b = new String(b.substring( 0,  4) + " " +
                   b.substring( 4,  8) + " " +
                   b.substring( 8, 12) + " " +
                   b.substring(12, 16) + " " +
                   b.substring(16, 20) + " " +
  ...
  public static void main(String[] args) {
    ...
    System.out.println(String.format("%8s: %-15s  0x%8s  %40s",
                                     "address",
